...
const CATEGORIES = [
  ...
  { slug: 'plastik-tabak', name: 'Plastik Tabak', pluralName: 'Tabaklar', iconName: 'DinnerDining', unitLabel: 'paket', sortOrder: 2, description: 'Renkli plastik tabaklar' },
  { slug: 'karton-bardak', name: 'Karton Bardak', pluralName: 'Bardaklar', iconName: 'LocalCafe', unitLabel: 'paket', sortOrder: 3, description: 'Temalı karton bardaklar' },
  { slug: 'plastik-bardak', name: 'Plastik Bardak', pluralName: 'Bardaklar', iconName: 'LocalCafe', unitLabel: 'paket', sortOrder: 4, description: 'Renkli plastik bardaklar' },
  ...
  { slug: 'plastik-catal', name: 'Plastik Çatal', pluralName: 'Çatallar', iconName: 'Restaurant', unitLabel: 'paket', sortOrder: 11, description: 'Renkli plastik çatallar' },
  { slug: 'plastik-bicak', name: 'Plastik Bıçak', pluralName: 'Bıçaklar', iconName: 'ContentCut', unitLabel: 'paket', sortOrder: 12, description: 'Renkli plastik bıçaklar' },
  { slug: 'balon', name: 'Balon', pluralName: 'Balonlar', iconName: 'BubbleChart', unitLabel: 'paket', sortOrder: 13, description: 'Lateks ve folyo balonlar' },
  { slug: 'mum', name: 'Mum', pluralName: 'Mumlar', iconName: 'Cake', unitLabel: 'adet', sortOrder: 14, description: 'Pasta mumları' },
];
